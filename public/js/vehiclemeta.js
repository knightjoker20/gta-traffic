...
function parseVehiclesMeta(
  ...
  items.forEach(item => {
    ...
    vehicleMeta[key] = {
      ...
      // Raw XML of this <Item> block — used by the spawn tuning
      // vehicles.meta exporter to patch traffic fields without
      // reconstructing the full entry from scratch.
      _rawXml: new XMLSerializer().serializeToString(item)
    };
