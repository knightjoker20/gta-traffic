...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Visible vehicles.meta drop zone on the imports panel
  const metaVisibleZone = document.getElementById("metaDropZoneVisible");
  if (metaVisibleZone) {
    setupDropZone(metaVisibleZone, handleVehicleMetaFile);
    // Click to open file picker
    metaVisibleZone.addEventListener("click", () => els.metaFilePicker.click());
  }
