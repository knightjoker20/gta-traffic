-- Migration 010: Add vanilla_vehicles reference table
-- Stores every Rockstar-published vehicle spawn name and its Jenkins hash.
-- Source: VehicleList.ini (921 vehicles, base game through latest DLC)

CREATE TABLE IF NOT EXISTS vanilla_vehicles (
  model_name TEXT NOT NULL PRIMARY KEY COLLATE NOCASE,
  hash       INTEGER NOT NULL
);

INSERT OR IGNORE INTO vanilla_vehicles (model_name, hash) VALUES
  ('adder', 3078201489),
  ('airbus', 1283517198),
  ('airtug', 1560980623),
  ('akula', 1181327175),
